        ...
        <Box  sx={{ display: "flex", height: "100vh" }}>
            ...
            >
                        ...
                        <List>
                            {[
                                ...
                                <ListItem key={obj.text} disablePadding>
                                    ...
                                    <Link to={obj.route} style={{width: '100%', textDecoration: 'none'}}>
                                        <ListItemButton key={index} >
                                            <PanoramaFishEyeIcon sx={{ color: "white", padding: 0.5 }} />
                                            <ListItemText primary={obj.text} sx={{ color: "whitesmoke" }} />
                                            {obj.text==="Todo" && 
                                            <p style={{
                                                borderRadius: 8, 
                                                alignSelf: 'end', 
                ...
                <Grid
                    ...
                    item={true}
                >
                    <Box sx={{ flexGrow: 1, bgcolor: "white", p: 5 }}>
                        {children}
                    </Box>
                </Grid>
            </Grid>
